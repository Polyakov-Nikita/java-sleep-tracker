...
public class LogLoaderTest {
    private static final Path LOG_PATH = Paths.get("sleep_log_test.txt");
    private static final Path LOG_PATH_SINGLE_STRING = Paths.get("sleep_log_test_SingleString.txt");
    private static final Path LOG_PATH_NO_STRINGS = Paths.get("sleep_log_test_NoStrings.txt");
    private static final Path LOG_PATH_ABSENT_FILE = Paths.get("sleep_log_test_AbsentFile.txt");
